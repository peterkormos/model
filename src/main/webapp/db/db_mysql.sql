...
INSERT INTO mak_users ( USER_ID, USER_PASSWORD, FIRST_NAME, LAST_NAME, USER_language, COUNTRY, ADDRESS, TELEPHONE, EMAIL, USER_ENABLED, YEAR_OF_BIRTH, city ) VALUES (1,'admin','secret','Peter','Kormos','ADMIN','Hungary','-','-','admin',1,1977,'-');
